...
> Add the Wazuh alert screenshot here.
...
> Add the Sysmon Event ID 11 screenshot here.
...
> Add the MITRE mapping screenshot here.
...
> Add the Threat Hunting query result here.

```markdown
<img width="1918" height="1031" alt="Image" src="https://github.com/user-attachments/assets/f8bbb766-22f9-48fd-938c-932a10326ad2" />
```
